...
Absolutely is developed using Ruby 2.5.8 and is additionally tested against Ruby 2.6 and 2.7 using [CircleCI](https://app.circleci.com/pipelines/github/jgarber623/absolutely).
