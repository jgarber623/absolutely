...
Absolutely is developed using Ruby 2.4.5 and is additionally tested against Ruby 2.5.4 and 2.6.1 using [Travis CI](https://travis-ci.com/jgarber623/absolutely).
